...
Important safety note: current defaults use placeholder credentials. Do not commit real credentials in values files.
...
Secrets currently use `stringData.username` and `stringData.password`.
